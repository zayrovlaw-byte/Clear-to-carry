...
/* Paid scheduling link (Calendly, Booksy, Acuity — anything that collects the
   fee at booking). Set NEXT_PUBLIC_BOOKING_URL and every "get started" button
   sends the visitor straight there to pick a time and pay in one step.
   Left empty, the site falls back to its own Zelle checkout, so nothing breaks
   before the scheduler is configured. See README "Booking and payment". */
...
export const TIERS = [
  { id: "tier-quick", tier: "Start here", name: "Get Started", price: 99,
    line: "Put $99 down and get moving today. The attorney takes it from there.",
    for: "Your first step, booked from this page: the attorney reviews your situation with you, tells you where you stand, and maps the path to your licence. Scheduled this week, often same day.",
    fine: "Initial consultation with the attorney",
    checkout: true, quick: true },
  { id: "tier-consult", tier: "The full hour", name: "Strategy Consultation", price: 350,
    line: "One hour with the attorney. Your eligibility, your options, your plan.",
    for: "The deep dive: your record reviewed, your licence chosen, your plan on paper. Credited toward any package if you retain us within 30 days.",
    checkout: true },
...
/* Site-wide promotion ribbon. Auto-hides after `until` (client clock).
   Seasonal framing only — the $99 consult is a standing price, so nothing
   here claims a discount that would need substantiation under RPC 7.1. */
export const PROMO = {
  eyebrow: "Labor Day",
  message: "Your work built something worth protecting.",
  cta: "Get started for just $99",
  fine: "initial consultation",
  href: "/apply?view=quick",
  until: "2026-09-14T04:00:00Z",
};
...
export const FAQS = [
  ...
  { q: "What does this cost?",
    a: "Getting started costs $99: an initial consultation with the attorney, booked directly from this site, where your situation is reviewed and your path is mapped. A full one-hour strategy consultation is $350, credited toward your fee if you retain us within 30 days. Full Representation is a flat fee between $2,500 and $3,500, fixed in writing in your engagement letter before any work begins. Where you land in that range depends on your record, not on which license you want: a clean, straightforward file sits at the bottom, and a file that needs real legal work sits higher. Separately, every applicant pays three third-party costs that never come to this firm: the State and City application fee, the 18-hour training course, and fingerprinting. Those are included in the Concierge engagement." },
...
export const ATTORNEY = {
  ...
  paragraphs: [
    ...
    "We were early. When Bruen came down, this firm was among the first in New York to advertise licensing as a dedicated practice, while most of the bar was still deciding whether the decision was real. Being early mattered less for the bragging rights than for what it produced: repetitions. The License Division's habits hold few surprises for us now.",

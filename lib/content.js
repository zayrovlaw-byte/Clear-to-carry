...
export const TIERS = [
  { id: "tier-quick", tier: "Start here", name: "10-Minute Consult", price: 99,
    line: "Ten minutes on the phone with the attorney. Straight answers about your situation.",
    for: "The fastest way to find out where you stand. You ask, the attorney answers, and you hang up knowing whether this is worth pursuing. Booked and done this week.",
...
export const PROMO = {
  ...
  cta: "$99 \u00b7 10 minutes with the attorney",
